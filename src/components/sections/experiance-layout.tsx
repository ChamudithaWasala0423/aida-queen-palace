  ...
  const experiences = [
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665839/g1_vcyfln.jpg",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665839/g2_seo32w.jpg",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665841/g3_was5ic.jpg",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665842/g4_kkqmww.jpg",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665841/g5_xno2e9.jpg",
      icon: <Turtle className="h-5 w-5" />,
      category: tc("wildlife"),
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665841/g6_y7lyc3.jpg",
      icon: <Waves className="h-5 w-5" />,
      category: tc("adventure"),
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665851/g7_a1mqqm.jpg",
      icon: <PalmTree className="h-5 w-5" />,
      category: tc("sightseeing"),
    },
    {
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665842/g9_xo7tpn.jpg",
      icon: <Waves className="h-5 w-5" />,
      category: tc("adventure"),
    },
    {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665842/g10_xtce7j.jpg",
      icon: <Waves className="h-5 w-5" />,
      category:  tc("adventure"),
    },
     {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755667432/sri-lanka-cinnamon_1_wtx6zj.png",
      icon: <Waves className="h-5 w-5" />,
      category:  tc("adventure"),
    },
       {
      ...
      image: "https://res.cloudinary.com/dy3lm6cvw/image/upload/v1755665862/g11_rsvpgy.jpg",
      icon: <Waves className="h-5 w-5" />,
      category:  tc("adventure"),
    },
  ]
      ...
      <Tabs defaultValue="grid" className="w-full py-10 mb-20">
        ...
        <TabsContent value="grid" className="mt-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {experiences.map((exp) => (
              <div key={exp.id} className="group relative overflow-hidden rounded-sm">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20 text-white">
                  ...
                  <p className="line-clamp-2 text-sm text-gray-200 mb-3">{exp.description}</p>
